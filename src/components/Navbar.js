    ...
    <header className="w-full px-32 py-8 font-medium flex items-center z-10 lg:px-16 md:px-12 sm:px-8 justify-between dark:text-light relative">
      ...
      {isOpen ? (
        <motion.div
          ...
          className="min-w-[70vw] flex flex-col justify-between z-30 items-center fixed top-1/3 
    -translare-x-1/2 -translare-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32"
        >
